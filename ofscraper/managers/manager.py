...
class mainManager:
    ...
    def print_name(self):
        console.get_shared_console().print(
            """ 
  ___  _____      ____   ____ ____      _    ____  _____ ____  
 / _ \|  ___|    / ___| / ___|  _ \    / \  |  _ \| ____|  _ \ 
| | | | |_ _____\___ \| |   | |_) |  / _ \ | |_) |  _| | |_) |
| |_| |  _|_____|___) | |___|  _ <  / ___ \|  __/| |___|  _ < 
 \___/|_|       |____/ \____|_| \_\/_/   \_\_|   |_____|_| \_\\
    ...
    def initLogs(self):
        if len(system.get_dupe_ofscraper()) > 0:
            console.get_shared_console().print(
                "[bold yellow]Warning: Another instance of this application is already running[bold yellow]\n\n\n"
            )
